    ...
    try {
      ...
      if (uid != null) {
        ...
        if (userDocument.exists) {
          ...
          print('Name: $name, Email: $email, Phone: $phoneNumber, University: $university');
        } else {
 ...
 left: 70,
            ...
            color: Colors.black,
                  child: Column(
                    ...
                    children: [
                      Text(name,style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontSize: 23),),
SizedBox(height: MediaQuery.sizeOf(context).height*0.01,),
                      Text(university,style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 23),),
